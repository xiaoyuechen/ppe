...
\begin{figure}[h]
  \centering \includegraphics[height=7cm]{src/ppe-callgraph.png}
...
\lstinputlisting[caption=OpenMP optimisation of Low-Pass Filter,
linerange=113-175]{src/main.cpp}
