  ...
  \begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
      ...
      \begin{tikzpicture}[scale=0.3]
        ...
        \draw<22->[green,thick] (1,-4) rectangle (3+1,-3-4);
        \draw<23->[brown,thick,->] (4.5,-4.5) -- (2.5,-5.5);
      \end{tikzpicture}
      \caption{Search window}
    \end{subfigure}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
      \centering
      \begin{tikzpicture}[scale=0.15]
        \draw[step=1,black,thin] (0,0) grid (30,-15);
        \draw[red,thick] (3,-3) rectangle (6,-6);
      \end{tikzpicture}
      \caption{Match frame}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
      ...
      \begin{tikzpicture}[scale=0.15]
        \draw[step=1,black,thin] (0,0) grid (30,-15);
        \draw[blue,thick] (0,0) rectangle (9,-9);
        \draw[green,thick] (0,0) rectangle (3,-3);
        \draw[brown,->,thick] (3+1.5,-3-1.5) -- (0+1.5,0-1.5);
      \end{tikzpicture}
      \caption{Search frame}
    \end{subfigure}
  \end{figure}
